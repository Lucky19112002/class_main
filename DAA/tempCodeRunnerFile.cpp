...
int main()
{
  ...
  //bubble short 
  {
    ...
    int bestCase = 0,sizeofarray1_1 = 0;
  ...
  system(" gnuplot -p -e \"set ylabel 'mileseconds' ; set xlabel 'data set' ; p 'G:/Sem_5/DAA/file_out/bsb.txt' using 1:2 w lp lc rgb 'blue' lw 2 pt 7 title 'bubble short best case','G:/Sem_5/DAA/file_out/bsa.txt' using 1:2 w lp lc rgb 'red' lw 2 pt 7 title 'bubble short avg case'\"");
  return 0;
}